...
export default async function PreviewPage({ params }: PreviewPageProps) {
  ...
  if (params.funnelId === "demo") {
    product = {
      ...
      description: "Learn how to build, scale, and automate your digital business in 30 days. This comprehensive course covers everything from SEO to paid ads.",
      price: 15000,
      isPublished: true,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex items-center gap-3 text-slate-300 bg-slate-900/50 p-3 rounded-lg border border-slate-800"><CheckCircle className="h-5 w-5 text-indigo-500" /><span>Instant Access</span></div>
              <div className="flex items-center gap-3 text-slate-300 bg-slate-900/50 p-3 rounded-lg border border-slate-800"><Lock className="h-5 w-5 text-indigo-500" /><span>Secure Checkout</span></div>
