...
export default async function PreviewPage({ params }: PreviewPageProps) {
  ...
  // 1. DEMO MODE: If checking the demo, return static 'Perfect' data.
  // This prevents the server crash when the DB tries to find ID "demo".
  if (params.funnelId === "demo") {
    product = {
      ...
      price: 15000,
      isPublished: true,
      fileUrl: "https://utfs.io/f/9e17300c-6625-4c03-b0c6-30d876d75c6d-1d.svg" // Placeholder image
    };
  } else {
    // 2. REAL MODE: Fetch from Database
    try {
