      ...
      <main className="py-24 px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          <div className="bg-[#0B0F1A] border border-slate-800 rounded-2xl p-8 shadow-xl flex flex-col relative overflow-hidden transform hover:scale-[1.01] transition-all duration-300">
            ...
            <div className="flex items-end gap-1 mb-6"><span className="text-4xl font-bold text-white">KES 0</span><span className="text-slate-500 mb-1">/month</span></div>
            ...
            <ul className="space-y-4 mb-8 flex-1">
              ...
              <li className="flex items-start gap-3 text-slate-300"><CheckCircle className="h-5 w-5 text-green-500 shrink-0" /> <span className="text-white font-bold">10% Transaction Fee</span></li>
              <li className="flex items-start gap-3 text-slate-300"><CheckCircle className="h-5 w-5 text-green-500 shrink-0" /> <span>Automated Split Payments</span></li>
            ...
            <Link href="/sign-up"><Button size="lg" className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold h-12 shadow-lg shadow-indigo-500/20">Start Selling for Free</Button></Link>
          </div>
          <div className="bg-[#020817] border border-slate-800 rounded-2xl p-8 shadow-lg flex flex-col opacity-75 hover:opacity-100 transition-opacity">
            ...
            <div className="flex items-end gap-1 mb-6"><span className="text-4xl font-bold text-white">KES 2,900</span><span className="text-slate-500 mb-1">/month</span></div>
        ...
        <div className="max-w-3xl mx-auto mt-20 text-center border-t border-slate-800 pt-12">
           ...
           <div className="text-left space-y-6 mt-8">
              <div className="p-4 rounded-lg bg-[#0B0F1A] border border-slate-800"><h4 className="font-semibold text-white">How does the 10% fee work?</h4><p className="text-slate-400 text-sm mt-1">We use automated split payments. When a customer pays, Paystack sends 90% to you and 10% to Nexus OS instantly.</p></div>
           </div>
        </div>
      </main>
    </div>
