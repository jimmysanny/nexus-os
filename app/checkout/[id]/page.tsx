...
export default async function CheckoutPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  // FIX: Handle possible null price safely
  ...
  return (
    <div className="min-h-screen bg-[#020817] flex items-center justify-center p-6">
      <div className="max-w-md w-full bg-[#0B0F1A] border border-slate-800 rounded-xl p-8">
        ...
        <p className="text-slate-400 mb-6">You are purchasing <span className="text-white font-medium">{product.name}</span></p>
        ...
        <div className="flex gap-2 text-xs text-green-400 items-center mb-8">
