...
function PayWithPaystack({ amount, email, planId, onSuccess }) {
    ...
    const componentProps = {
        ...
        onSuccess: ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Payment Received!");
            if (onSuccess) onSuccess();
        },
        onClose: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].info("Payment cancelled")
    };
